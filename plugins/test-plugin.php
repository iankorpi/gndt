...
add_shortcode('test_shortcode', 'get_shortcode_example_shortcode');
/* Register the notice function to print using the admin_notices hook. */
add_action( 'admin_notices', 'add_notice_shortcode_plugin_active');
?>
